...
AddEventHandler('gothic_jobcenter:setjob1', function(job)
	TriggerServerEvent("gothic_jobcenter:setjob1")
end)

AddEventHandler('gothic_jobcenter:setjob2', function(job)
	TriggerServerEvent("gothic_jobcenter:setjob2")
end)


AddEventHandler('gothic_jobcenter:setjob3', function(job)
	TriggerServerEvent("gothic_jobcenter:setjob3")
end)



RegisterNetEvent('gothic_jobcenter:open', function(job)
    lib.registerContext({
        id = 'jobcenter_menu',
        title = 'JOB CENTER',
        onExit = function()
        ...
        options = {
            {
                ...
                event = 'gothic_jobcenter:setjob1'     
            },
            {
                title = 'TRUCKER JOB',
                ...
                event = 'gothic_jobcenter:setjob2'
            },
            {
                ...
                event = 'gothic_jobcenter:setjob3'
            }
        }
    })
